(function(definition){Display=definition(typeof(Parallelio.DOM)!=="undefined"?Parallelio.DOM:this.Parallelio.DOM);Display.definition=definition;if(typeof(module)!=="undefined"&&module!==null){module.exports=Display;}else{if(typeof(Parallelio.DOM)!=="undefined"&&Parallelio.DOM!==null){Parallelio.DOM.Display=Display;}else{if(this.Parallelio.DOM==null){this.Parallelio.DOM={};}this.Parallelio.DOM.Display=Display;}}})(function(dependencies){if(dependencies==null){dependencies={};}
